...
3.  **🤖 AI 블로그 포스팅 원고 & 쇼츠 4컷(9:16) 삽화 프롬프트 원스톱 생성 스튜디오**
    ...
    *   **[Step 3] 네이버 블로그 복사-붙여넣기 템플릿**: 클릭을 부르는 추천 제목 3선, 3초 도입부 요약, H1~H3 구조화 본문, 핵심 데이터 표, 에디터 공감 코멘트, 추천 태그 8~10개 일괄 출력.
    *   **[Step 4] 9:16 세로형 쇼츠/릴스 연동 4컷 삽화 프롬프트**: 일관된 아트 스타일을 바탕으로 1컷(훅 0~2초), 2컷(문제제기 3~5초), 3컷(해결책 6~8초), 4컷(피날레/CTA 9~12초) 한글 및 Imagen 3 영문 프롬프트 생성.
4.  **연관 금융 정보 수집**
