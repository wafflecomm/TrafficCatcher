...
## 4. 뉴스 기사 분석 및 교차 종합 가이드 (News Analysis Rules)
시사/이슈 기사 또는 뉴스를 기반으로 작성할 때는 단편적인 보도를 지양하고 다각도의 팩트와 배경을 입체적으로 다룹니다:
- **3대 관점 교차 분석**: 
  1. **관점 A (현안 중심)**: 발생 배경 및 팩트 중심의 신속한 사건 흐름 파악.
  2. **관점 B (파급 효과)**: 관련 업계, 이해관계자들의 입장 및 향후 장기적 영향력 분석.
  3. **관점 C (심층 분석)**: 배경 원인 분석, 전문가 제언, 유사 사례 대조를 통한 객관적 시각 확보.
- **객관성과 중립성**: 자극적인 어그로를 지양하고, 다각도의 팩트 체크를 통해 독자 신뢰도를 얻는 양질의 저널리즘 스타일 블로그를 완성합니다.
...
- *불릿 포인트 형태로 핵심 요약 3줄 작성*

#### 1. [소제목 h2: 호기심과 가치를 전하는 매력적인 타이틀]
- *도입부 및 배경 설명. 독자의 공감을 이끌어내는 친근한 어투 활용.*
- *(광고 삽입 포인트 1: 제목 아래 1단락 후)*

#### 2. [소제목 h2: 구체적인 정보와 분석]
- *상세 내용 전개. 핵심적인 내용 비교 또는 일정 정리가 포함된 **상세 도표(Table)** 제공.*

#### 3. [소제목 h2: 파급 효과 및 전문가 분석]
- *이슈의 영향력이나 깊이 있는 팩트 분석 제시.*
- *(광고 삽입 포인트 2: 3~4번째 소제목 사이)*
