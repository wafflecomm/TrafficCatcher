...
>
> 로컬 실시간 데이터는 10분 주기로 수집하고, 클라우드 예약 시각은 Cloudflare Cron Trigger가 관리하며 GitHub Actions는 수집 실행기로 사용한다.
...
- 현재의 24시간 매 10분 자동 수집을 유지하면서 버튼으로 즉시 수집도 허용한다.
...
- 로컬 서버: 실시간 데이터 10분 간격 자동 수집
- Cloudflare Cron: 24시간 10분 간격으로 GitHub 실시간 수집 워크플로 호출
